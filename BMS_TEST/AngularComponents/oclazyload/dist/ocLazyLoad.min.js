...
!function () {
    ...
    function r(e) {
        try {
            ...
            throw (/No module/.test(n) || n.message.indexOf("$injector:nomod") > -1) && (n.message = 'The module "' + e + '" that you are trying to load does not exist. ' + n.message),
            n
        }
    }
    function a(e, n, r, a) {
            ...
            i = n.length; i > t; t++)
                ...
                angular.isArray(u)) {
                    ...
                    if ("invoke" !== u[1])
                        ...
                        var f = function (e) {
                            var n = c.indexOf(r + "-" + e);
                            (-1 === n || a) && (-1 === n && c.push(r + "-" + e),
                            angular.isDefined(l) && l[u[1]].apply(l, u[2]))
                        };
    ...
    function t(e, n, r) {
        if (n) {
            ...
            for (o = n.length - 1; o >= 0; o--)
                ...
                u && -1 === d.indexOf(u)) {
                    var c = -1 === l.indexOf(u);
                    if (s = angular.module(u),
                    c && (l.push(u),
                    t(e, s.requires, r)),
                    s._runBlocks.length > 0)
                        for (g[u] = []; s._runBlocks.length > 0;)
                            g[u].push(s._runBlocks.shift());
                    angular.isDefined(g[u]) && (c || r.rerun) && (f = f.concat(g[u])),
                    a(e, s._invokeQueue, u, r.reconfig),
                    a(e, s._configBlocks, u, r.reconfig),
                    p(c ? "ocLazyLoad.moduleLoaded" : "ocLazyLoad.moduleReloaded", u),
                    n.pop(),
                    d.push(u)
                }
    ...
    function o(e, n) {
        var r = e[2][0]
          , a = e[1]
          , t = !1;
        angular.isUndefined(f[n]) && (f[n] = {}),
        angular.isUndefined(f[n][a]) && (f[n][a] = []);
        var o = function (e) {
            t = !0,
            f[n][a].push(e),
            p("ocLazyLoad.componentLoaded", [n, a, e])
        };
    ...
    function i(e) {
        var n = null;
        return angular.isString(e) ? n = e : angular.isObject(e) && e.hasOwnProperty("name") && angular.isString(e.name) && (n = e.name),
        n
    }
    function u(e) {
        if (0 === s.length) {
            ...
            angular.forEach(r, function (n) {
                ...
                n = n.replace(":", "\\:"),
                e[0].querySelectorAll && (angular.forEach(e[0].querySelectorAll("." + n), o),
                angular.forEach(e[0].querySelectorAll("." + n + "\\:"), o),
                angular.forEach(e[0].querySelectorAll("[" + n + "]"), o))
            }),
        ...
        var i = function u(e) {
            if (-1 === l.indexOf(e)) {
                ...
                a(null, n._invokeQueue, e),
                a(null, n._configBlocks, e),
                angular.forEach(n.requires, u)
            }
        };
    ...
    h.provider("$ocLazyLoad", ["$controllerProvider", "$provide", "$compileProvider", "$filterProvider", "$injector", "$animateProvider", function (a, o, s, f, c, g) {
        ...
        u(angular.element(window.document)),
        this.$get = ["$log", "$q", "$templateCache", "$http", "$rootElement", "$rootScope", "$cacheFactory", "$interval", function (a, o, u, s, f, c, g, E) {
            var $, x = g("ocLazyLoad"), b = !1, z = !1;
            O || (a = {},
            a.error = angular.noop,
            a.warn = angular.noop,
            a.info = angular.noop),
            ...
            var P = function (e, n, r) {
                ...
                switch (angular.isUndefined(x.get(n)) && x.put(n, i.promise),
                e) {
                    case "css":
                        a = document.createElement("link"),
                        a.type = "text/css",
                        a.rel = "stylesheet",
                        a.href = r.cache === !1 ? u(n) : n;
                        break;
                    case "js":
                        a = document.createElement("script"),
                        a.src = r.cache === !1 ? u(n) : n;
                        break;
                    default:
                        i.reject(new Error('Requested type "' + e + '" is not known. Could not inject "' + n + '"'))
                }
                a.onload = a.onreadystatechange = function () {
                    a.readyState && !/^c|loade/.test(a.readyState) || t || (a.onload = a.onreadystatechange = null,
                    t = 1,
                    p("ocLazyLoad.fileLoaded", n),
                    i.resolve())
                }
                ,
                a.onerror = function () {
            ...
            ,
            h.ocLazyLoadLoader = !0),
            angular.isUndefined(m) && (m = function (e, n, r) {
                var a = [];
                angular.forEach(e, function (e) {
                    a.push(P("css", e, r))
                }),
            ...
            ,
            m.ocLazyLoadLoader = !0),
            angular.isUndefined(v) && (v = function (e, n, r) {
                var a = [];
                return angular.forEach(e, function (e) {
                    var n = o.defer();
                    a.push(n.promise),
                    s.get(e, r).success(function (r) {
                        ...
                        angular.isUndefined(x.get(e)) && x.put(e, !0),
                        n.resolve()
                    }).error(function (r) {
            ...
            var D = function (e, n) {
                ...
                var s = function (e) {
                    l = x.get(e),
                    angular.isUndefined(l) || n.cache === !1 ? /\.(css|less)[^\.]*$/.test(e) && -1 === r.indexOf(e) ? r.push(e) : /\.(htm|html)[^\.]*$/.test(e) && -1 === t.indexOf(e) ? t.push(e) : -1 === i.indexOf(e) && i.push(e) : l && u.push(l)
                };
                ...
                r.length > 0) {
                    var f = o.defer();
                    m(r, function (e) {
                        angular.isDefined(e) && m.hasOwnProperty("ocLazyLoadLoader") ? (a.error(e),
                        f.reject(e)) : f.resolve()
                    }, n),
                    u.push(f.promise)
                }
                if (t.length > 0) {
                    var c = o.defer();
                    v(t, function (e) {
                        angular.isDefined(e) && v.hasOwnProperty("ocLazyLoadLoader") ? (a.error(e),
                        c.reject(e)) : c.resolve()
                    }, n),
                    u.push(c.promise)
                }
                if (i.length > 0) {
                    var d = o.defer();
                    h(i, function (e) {
                        angular.isDefined(e) && h.hasOwnProperty("ocLazyLoadLoader") ? (a.error(e),
                        d.reject(e)) : d.resolve()
                    }, n),
                    u.push(d.promise)
                }
            ...
            return {
                ...
                load: function (u, s) {
                    ...
                    angular.isArray(u))
                        ...
                        v.promise;
                    if (f = i(u),
                    "string" == typeof u ? (h = g.getModuleConfig(u),
                    h || (h = {
                        files: [u]
                    },
                    f = null)) : "object" == typeof u && (h = g.setModuleConfig(u)),
                    null === h ? (c = 'Module "' + f + '" is not configured, cannot load.',
                    a.error(c),
                    v.reject(new Error(c))) : angular.isDefined(h.template) && (angular.isUndefined(h.files) && (h.files = []),
                    angular.isString(h.template) ? h.files.push(h.template) : angular.isArray(h.template) && h.files.concat(h.template)),
                    p.push = function (e) {
                        -1 === this.indexOf(e) && Array.prototype.push.apply(this, arguments)
                    }
                    ,
                    angular.isDefined(f) && n(f) && -1 !== l.indexOf(f) && (p.push(f),
                    angular.isUndefined(h.files)))
                        return v.resolve(),
                        v.promise;
                    var y = {};
                    ...
                    var w = function O(t) {
                        ...
                        angular.forEach(s, function (e) {
                            ...
                            0 !== f.length && a.warn('Module "', u, '" attempted to redefine configuration for dependency. "', e.name, '"\n Additional Files Loaded:', f),
                            c.push(D(e.files, y).then(function () {
                                return O(e)
                            })))) : ("object" == typeof e && (e.hasOwnProperty("name") && e.name && (g.setModuleConfig(e),
                            p.push(e.name)),
                            e.hasOwnProperty("css") && 0 !== e.css.length && angular.forEach(e.css, function (e) {
                                P("css", e, y)
                            })),
        ...
        this.config = function (e) {
            ...
            angular.isDefined(e.debug) && (O = e.debug),
            angular.isDefined(e.events) && (j = e.events)
        }
    }
    ]),
